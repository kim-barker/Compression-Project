...
##                break
                ...
                lo -= half
                hi -= half
##                print('here 2 more half')
                lo *= 2
                hi = 2*hi +1
##                print('here 5 lo hi', lo, hi)
##                break
...
##            print('here 5 lo hi', lo, hi)
    ...
    if lo < quarter: # the position of lo determines the dyadic interval that fits
        ...
        y.append(1)
        for i in range(straddle):y.append(0)
